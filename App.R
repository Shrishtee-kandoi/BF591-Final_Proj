...
ui <- fluidPage(theme = shinythemes::shinytheme("cerulean"),
                ...
                tabsetPanel(
                  ...
                  #---------------------------------------------------------IGE------------------------------------------------------------
                  tabPanel("IGE",
                           h3("Individual Gene Expression visualization from Normalized Counts and Sample metadata"),
                           p("This tab can be used to look at the expression of individual genes using counts. ",
                             "It loads a matrix of normalized count data, sample metadata, ",
                             "user input for metadata category, and ",
                             "user input for an ENSEMBL gene ID and finally plots a scatter plot on hitting plot"),
                           sidebarLayout(
                             sidebarPanel(
